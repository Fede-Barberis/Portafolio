...
const Experiencia = () => {
    return (
        <section id="experiencia" className="flex flex-col mt-24 mb-28">
            <div className='space-y-6 '>
                <header className='flex fle-row gap-2'>
                    <IconBriefcase stroke={2} className='text-gray-600' />
                    <h2 className="text-lg font-heading font-medium text-gray-800">Experiencia Laboral</h2>
                </header>
                <main>
                    <ul>
                        <li className='space-y-6'>
                            <div>
                                <div className='space-y-1'>
                                    ...
                                    <h2 className='text-xl font-heading font-medium '>Operario polivalente</h2>
                                </div>
                                <p className='text-sm pt-2 text-blue-300'>Enero 2022 - Actualidad</p>
                            </div>
                            <ul className="space-y-2 list-disc list-inside text-black/50 text-sm">
