...
export const ProjectCardVertical = ({ title, description, image, link, repo, lenguaje }) => {
    return (
        <div className="flex flex-col w-full h-full">
            ...
            <div className="flex flex-col gap-2 flex-1 space-y-1 mt-3">
...
export const ProjectCardHorizontal = ({ title, description, image, link, repo, lenguaje }) => {
    return (
        <div className="flex flex-row gap-8 h-full ">
            <div className="h-full overflow-hidden rounded-xl shadow">
                <img 
                src={image} 
                alt={title} 
                className="w-70 h-48 object-cover rounded-xl scale-105 hover:scale-100 duration-700 transition-transform" />
            </div>
